...
class SAHP(nn.Module):
    ...
    def compute_intens_at_given_time(self, seq_times):
    ...
    def compute_loss(self, seq_times, seq_onehot_types,n_mc_samples = 20):
        ...
        return res, intens_at_evs, log_intensities_ret, partial_integrals
