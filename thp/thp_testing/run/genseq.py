...
def main():
    ...
    parser.add_argument('-d_model', "--ModelDim", type=int, default=512)
    parser.add_argument(
        '-n_layer', '--Layer', default=4, type=int,
        help='the number of layers of Transformer'
    )
    parser.add_argument('-n_head', "--NumHead", type=int, default=4)
    parser.add_argument('-d_rnn', "--RNNDim", type=int, default=64)
    parser.add_argument('-d_inner_hid', "--InnerHiddenDim", type=int, default=1024)
    parser.add_argument('-d_k', "--KeyDim", type=int, default=512)
    parser.add_argument('-d_v', "--ValueDim", type=int, default=512)
    ...
    if args.Domain == args.FolderName:
        ...
        if args.LoadFromPretrain:
            path_logs = os.path.join( args.PathDomain, 'GaTechLogs', args.FolderName )
            ...
            args.PathModelDir = os.path.join(args.SavePath, "Logs", "ground_truth")
