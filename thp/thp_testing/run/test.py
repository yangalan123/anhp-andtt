...
from thp.thp_testing.esm.tester import Tester
...
def main():
    ...
    if args.Domain == args.FolderName:
        ...
        args.BatchSize = saved_args["batch_size"]
        args.d_model = saved_args["d_model"]
        args.n_head = saved_args["n_head"]
        args.n_layers = saved_args["n_layers"]
        args.d_rnn = saved_args["d_rnn"]
        args.d_inner = saved_args["d_inner_hid"]
        args.d_k = saved_args["d_k"]
        args.d_v = saved_args["d_v"]
